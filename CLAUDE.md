...
- ⏸ **Phase B/C STOP — pivot décision** : 3/3 calibration targets ont asymptoté à E[R]<0 (Morning_Trap -0.081, Liquidity_Sweep -0.034, BOS_Scalp -0.118). Aucune calibration single-signal n'a produit E[R]>0 sur 4 semaines. Recommandation : freeze single-signal calibration, pivoter vers (A) accepter BOS_Scalp DENYLIST (3e SIGNAL_QUALITY_SUSPECT confirmé), (B) test TP1 1.5→0.5R sur BOS_Scalp (risque codifier signal-quality issue), ou (C) survivor analysis portfolio (lister tous playbooks E[R]≥-0.05, examiner combinaisons).
