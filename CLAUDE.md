...
- ✓ **Aplus_03 IFVG Flip v1** (2026-04-20) — première instantiation fidèle de Family A (Phase D.2 gap). Deux variants (LAB+SAFE), 4 semaines caps actives, 61 trades. LAB E[R]=**-0.074** (WR 36%, peak_R p60=**0.68R** clears signal-quality bar), SAFE E[R]=-0.142 (n=14 trop petit). **0/61 TPs hit** — fixed RR 2.0R unreachable vs peak_R p80=1.06R. Per-week LAB: jun +0.025, aug +0.020, oct -0.068, nov -0.213. Signal NOT null (WR + peak_R cleans), mais TP structure inadaptée. **Prochaine étape proposée** : calibration minimale TP1 2.0→0.70R, BE 1.5→0.40R sur LAB uniquement, re-run 4 semaines. Voir [aplus03_v1_verdict.md](backend/data/backtest_results/aplus03_v1_verdict.md).
